...
Reaction::Reaction( std::vector<Element*> initReactants, std::vector<Element*> initProducts, double initProb )
{
   ...
   {
      std::cerr << "Loading rxn: reaction is not balanced!" << std::endl;
      exit( EXIT_FAILURE );
   }
   ...
   {
      std::cerr << "Loading rxn: reactions must contain at least one and no more than two reactants and products each!" << std::endl;
      exit( EXIT_FAILURE );
   }
   ...
   {
      std::cerr << "Loading rxn: probability must fall between 0 and 1!" << std::endl;
      exit( EXIT_FAILURE );
   }
...
Reaction::setProducts( std::vector<Element*> newProducts )
{
   ...
   {
      std::cerr << "setProducts: reaction is not balanced!" << std::endl;
      exit( EXIT_FAILURE );
   }
...
Reaction::setProb( double newProb )
{
   ...
   {
      std::cerr << "setProb: probability must fall between 0 and 1!" << std::endl;
      exit( EXIT_FAILURE );
   }
